 ...
 * [DynamicFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [DynamicFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class DynamicFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btnDynamicFragment.setOnClickListener { onButtonPressed(etDynamicFragment.text.toString()) }
    }
